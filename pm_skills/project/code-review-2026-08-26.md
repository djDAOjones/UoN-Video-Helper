...
| P3-05 | Maintainer documentation and one generator have material drift | [`architecture.md`](architecture.md#L56) names nonexistent bus/store/sidecar/branding/UI modules and an obsolete protocol; [`DEV-INFRASTRUCTURE.md`](../../DEV-INFRASTRUCTURE.md#L377) says local-only while [`deploy-pages.yml`](../../.github/workflows/deploy-pages.yml#L14) deploys every push to `main`; [`gen-placeholder-branding.mjs`](../../scripts/gen-placeholder-branding.mjs#L38) still generates obsolete closing placeholders. Reconcile in the protected-doc/doc-sync workflow rather than silently editing here. |
